...
def fight(df: pd.DataFrame, username: str) -> None:
    ...
    try:
        ...
        # Save figure
        output_path = os.path.join(os.path.abspath(username), "fight.png")
...
def wh_countplot(df: pd.DataFrame, username: str) -> None:
    ...
    try:
        ...
        # Save figure
        output_path = os.path.join(os.path.abspath(username), "top_op_wh.png")
        os.makedirs(os.path.dirname(output_path), exist_ok=True)
...
def bl_countplot(df: pd.DataFrame, username: str) -> None:
    ...
    try:
        ...
        # Save figure
        output_path = os.path.join(os.path.abspath(username), "top_op_bl.png")
        os.makedirs(os.path.dirname(output_path), exist_ok=True)
        plt.savefig(output_path, bbox_inches='tight', dpi=300)
        plt.close()
...
def most_used_wh(df: pd.DataFrame, username: str) -> None:
    ...
    try:
        ...
        for x in top_move_list:
            ...
            output_path = os.path.join(os.path.abspath(username), f'top_opening_move_as_white_{num}.png')
            os.makedirs(os.path.dirname(output_path), exist_ok=True)
...
def create_rating_ladder(df: pd.DataFrame, username: str) -> None:
    ...
    try:
        ...
        # Save figure
        output_path = os.path.join(os.path.abspath(username), "rating_ladder_red.png")
        os.makedirs(os.path.dirname(output_path), exist_ok=True)
...
def create_result_distribution(df: pd.DataFrame, username: str) -> None:
    ...
    try:
        ...
        # Save figure
        output_path = os.path.join(os.path.abspath(username), "result_pi.png")
        os.makedirs(os.path.dirname(output_path), exist_ok=True)
...
def create_time_control_dist(df: pd.DataFrame, username: str) -> None:
    ...
    try:
        ...
        output_path = os.path.join(os.path.abspath(username), "time_class.png")
        os.makedirs(os.path.dirname(output_path), exist_ok=True)
        plt.savefig(output_path, dpi=300, bbox_inches='tight', facecolor='white')
        plt.close()
...
def create_color_results(df: pd.DataFrame, username: str) -> None:
    ...
    try:
        ...
        output_path = os.path.join(os.path.abspath(username), "result_as_wh.png")
        os.makedirs(os.path.dirname(output_path), exist_ok=True)
        ...
        output_path = os.path.join(os.path.abspath(username), "result_as_bl.png")
...
def create_top_5_openings(df: pd.DataFrame, username: str) -> None:
    ...
    try:
        ...
        output_path = os.path.join(os.path.abspath(username), "result_top_5_wh.png")
        os.makedirs(os.path.dirname(output_path), exist_ok=True)
        plt.savefig(output_path, dpi=300, bbox_inches='tight')
        plt.close()
        ...
        output_path = os.path.join(os.path.abspath(username), "result_top_5_bl.png")
        os.makedirs(os.path.dirname(output_path), exist_ok=True)
        plt.savefig(output_path, dpi=300, bbox_inches='tight')
        plt.close()
...
def create_overall_results(df: pd.DataFrame, username: str) -> None:
    ...
    try:
        ...
        output_path = os.path.join(os.path.abspath(username), "overall_results.png")
        os.makedirs(os.path.dirname(output_path), exist_ok=True)
        plt.savefig(output_path, dpi=300, bbox_inches='tight', facecolor='white')
        plt.close()
...
def wh_heatmap_beg(df: pd.DataFrame, username: str) -> None:
    ...
    output_path = os.path.join(os.path.abspath(username), "heatmap_starting_white.png")
    os.makedirs(os.path.dirname(output_path), exist_ok=True)
    plt.savefig(output_path, bbox_inches='tight', dpi=300)
    plt.close()
...
def wh_heatmap_end(df: pd.DataFrame, username: str) -> None:
    ...
    output_path = os.path.join(os.path.abspath(username), "heatmap_landing_white.png")
    os.makedirs(os.path.dirname(output_path), exist_ok=True)
    plt.savefig(output_path, bbox_inches='tight', dpi=300)
    plt.close()
...
def bl_heatmap_beg(df: pd.DataFrame, username: str) -> None:
    ...
    output_path = os.path.join(os.path.abspath(username), "heatmap_starting_black.png")
    os.makedirs(os.path.dirname(output_path), exist_ok=True)
    plt.savefig(output_path, bbox_inches='tight', dpi=300)
    plt.close()
...
def bl_heatmap_end(df: pd.DataFrame, username: str) -> None:
    ...
    output_path = os.path.join(os.path.abspath(username), "heatmap_landing_black.png")
    os.makedirs(os.path.dirname(output_path), exist_ok=True)
    plt.savefig(output_path, bbox_inches='tight', dpi=300)
    plt.close()
...
def create_combined_heatmaps(df: pd.DataFrame, username: str) -> None:
    ...
    try:
        ...
        plt.subplot(1, 2, 1)
        img1 = plt.imread(os.path.join(username, "heatmap_starting_white.png"))
        plt.imshow(img1)
        plt.axis('off')
        
        # White landing squares
        plt.subplot(1, 2, 2)
        img2 = plt.imread(os.path.join(username, "heatmap_landing_white.png"))
        plt.imshow(img2)
        plt.axis('off')
        
        plt.suptitle("Starting and Landing Square Heatmaps as White", size=24, y=1.02)
        plt.tight_layout()
        plt.savefig(os.path.join(username, "heatmap_combined_white.png"), 
        ...
        plt.subplot(1, 2, 1)
        img3 = plt.imread(os.path.join(username, "heatmap_starting_black.png"))
        plt.imshow(img3)
        plt.axis('off')
        
        # Black landing squares
        plt.subplot(1, 2, 2)
        img4 = plt.imread(os.path.join(username, "heatmap_landing_black.png"))
        plt.imshow(img4)
        plt.axis('off')
        
        plt.suptitle("Starting and Landing Square Heatmaps as Black", size=24, y=1.02)
        plt.tight_layout()
        plt.savefig(os.path.join(username, "heatmap_combined_black.png"), 
                   bbox_inches='tight', dpi=300)
        plt.close()

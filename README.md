...
1. Install GTK3 Runtime Environment (required for CairoSVG):
   - Download the latest GTK3 installer from [GTK for Windows Runtime Environment Installer](https://github.com/tschoonj/GTK-for-Windows-Runtime-Environment-Installer/releases)
...
1. Clone the repository:
   ...
   ```bash
   git clone https://github.com/yogen-ghodke-113/Statistical-Analysis-of-a-Chess-Player-using-Data-Science-Pipeline.git
   cd Statistical-Analysis-of-a-Chess-Player-using-Data-Science-Pipeline
   ```
...
If you encounter CairoSVG related errors:

- **Windows Users**: Make sure GTK3 is properly installed and your system was restarted
- **Linux Users**: Install Cairo development files:
  ```bash
  sudo apt-get install libcairo2-dev pkg-config python3-dev
  ```
- **Mac Users**: Install Cairo using Homebrew:
  ```bash
...
Chess is a game with near infinite possibilities and every game played produces large amounts of data. This project aims to provide chess enthusiasts a tool to improve their game with assistance from several Machine Learning and Data Science techniques, by studying their previous games.
